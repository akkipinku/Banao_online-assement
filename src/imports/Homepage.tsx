...
import imgEllipse6 from "figma:asset/5b78b09e2b0114b1413725ca676cec3338ced81f.png";
import imgEllipse7 from "figma:asset/0f49247b48877972689d58c29cf3115c4d3d4645.png";
import imgEllipse9 from "figma:asset/60cab0e9c4a7483d5ed6cd85cd1f13ac10282ff5.png";
import imgEllipse10 from "figma:asset/4b0f7d937532e2dbdb02338644f2e908965c75c7.png";
import imgEllipse11 from "figma:asset/1fe158899cc9d166fccb1ac0f943ac3178774cd4.png";

function Group7() {
  return (
    <div className="absolute h-[851px] left-[107px] top-[-4px] w-[1227px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1227 851">
        <g id="Group 95">
          <path clipRule="evenodd" d={svgPaths.p35126e00} fill="url(#paint0_linear_1_1000)" fillRule="evenodd" id="Line 2 (Stroke)" />
          <path clipRule="evenodd" d={svgPaths.p326af700} fill="url(#paint1_linear_1_1000)" fillRule="evenodd" id="Line 3 (Stroke)" />
          <path clipRule="evenodd" d={svgPaths.p24afd900} fill="url(#paint2_linear_1_1000)" fillRule="evenodd" id="Line 4 (Stroke)" />
          <path clipRule="evenodd" d={svgPaths.p2f2152c0} fill="url(#paint3_linear_1_1000)" fillRule="evenodd" id="Line 5 (Stroke)" />
          <path clipRule="evenodd" d={svgPaths.p3e817580} fill="url(#paint4_linear_1_1000)" fillRule="evenodd" id="Line 6 (Stroke)" />
          <path clipRule="evenodd" d={svgPaths.p11385e80} fill="url(#paint5_linear_1_1000)" fillRule="evenodd" id="Line 7 (Stroke)" />
          <path clipRule="evenodd" d={svgPaths.p486df00} fill="url(#paint6_linear_1_1000)" fillRule="evenodd" id="Line 8 (Stroke)" />
          <path clipRule="evenodd" d={svgPaths.p2eecf900} fill="url(#paint7_linear_1_1000)" fillRule="evenodd" id="Line 9 (Stroke)" />
          <path clipRule="evenodd" d={svgPaths.p133bf900} fill="url(#paint8_linear_1_1000)" fillRule="evenodd" id="Line 10 (Stroke)" />
          <path clipRule="evenodd" d={svgPaths.p3c71ea80} fill="url(#paint9_linear_1_1000)" fillRule="evenodd" id="Line 11 (Stroke)" />
          <path clipRule="evenodd" d={svgPaths.p3a5bd980} fill="url(#paint10_linear_1_1000)" fillRule="evenodd" id="Line 12 (Stroke)" />
          <path clipRule="evenodd" d={svgPaths.p86dfe00} fill="url(#paint11_linear_1_1000)" fillRule="evenodd" id="Line 13 (Stroke)" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_1000" x1="1.77905e-05" x2="0.654542" y1="425.5" y2="425.5">
            <stop stopColor="#404047" />
            <stop offset="1" stopColor="#404047" stopOpacity="0" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_1_1000" x1="111.471" x2="112.125" y1="425.5" y2="425.5">
            <stop stopColor="#404047" />
            <stop offset="1" stopColor="#404047" stopOpacity="0" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_1_1000" x1="222.942" x2="223.597" y1="425.5" y2="425.5">
            <stop stopColor="#404047" />
            <stop offset="1" stopColor="#404047" stopOpacity="0" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint3_linear_1_1000" x1="334.413" x2="335.067" y1="425.5" y2="425.5">
            <stop stopColor="#404047" />
            <stop offset="1" stopColor="#404047" stopOpacity="0" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint4_linear_1_1000" x1="445.884" x2="446.538" y1="425.5" y2="425.5">
            <stop stopColor="#404047" />
            <stop offset="1" stopColor="#404047" stopOpacity="0" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint5_linear_1_1000" x1="557.355" x2="558.009" y1="425.5" y2="425.5">
            <stop stopColor="#404047" />
            <stop offset="1" stopColor="#404047" stopOpacity="0" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint6_linear_1_1000" x1="668.826" x2="669.48" y1="425.5" y2="425.5">
            <stop stopColor="#404047" />
            <stop offset="1" stopColor="#404047" stopOpacity="0" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint7_linear_1_1000" x1="780.297" x2="780.951" y1="425.5" y2="425.5">
            <stop stopColor="#404047" />
            <stop offset="1" stopColor="#404047" stopOpacity="0" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint8_linear_1_1000" x1="891.768" x2="892.422" y1="425.5" y2="425.5">
            <stop stopColor="#404047" />
            <stop offset="1" stopColor="#404047" stopOpacity="0" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint9_linear_1_1000" x1="1003.24" x2="1003.89" y1="425.5" y2="425.5">
            <stop stopColor="#404047" />
            <stop offset="1" stopColor="#404047" stopOpacity="0" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint10_linear_1_1000" x1="1114.71" x2="1115.36" y1="425.5" y2="425.5">
            <stop stopColor="#404047" />
            <stop offset="1" stopColor="#404047" stopOpacity="0" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint11_linear_1_1000" x1="1226" x2="1226.65" y1="386.5" y2="386.5">
            <stop stopColor="#404047" />
            <stop offset="1" stopColor="#404047" stopOpacity="0" />
          </linearGradient>
        </defs>
...
function Frame4() {
  return (
    <div className="absolute bg-[#18181c] content-stretch flex items-start left-[735px] px-[28px] py-[12px] rounded-[5px] top-[4135px] w-[408px]">
      <p className="font-['Poppins:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#9e9e9e] text-[14px] whitespace-pre">Your Email</p>
    </div>
  );
}
...
function Frame5() {
  return (
    <div className="absolute bg-[#18181c] content-stretch flex items-start left-[735px] px-[28px] py-[12px] rounded-[5px] top-[4197px] w-[408px]">
      <p className="font-['Poppins:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#9e9e9e] text-[14px] whitespace-pre">Name</p>
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="absolute bg-[#18181c] content-stretch flex h-[156px] items-start left-[735px] px-[28px] py-[12px] rounded-[5px] top-[4259px] w-[408px]">
      <p className="font-['Poppins:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#9e9e9e] text-[14px] whitespace-pre">Name</p>
    </div>
  );
}
...
function Frame7() {
  return (
    <div className="absolute content-stretch flex items-start left-[735px] px-[28px] py-[12px] rounded-[5px] top-[4433px]" style={{ backgroundImage: "linear-gradient(98.0963deg, rgb(255, 152, 152) 0.47654%, rgb(128, 84, 255) 100%)" }}>
      <p className="font-['Poppins:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[14px] text-white whitespace-pre">Get in Touch</p>
    </div>
  );
}
...
function Component0043DModel() {
  return <div className="absolute h-[45.96px] left-[318px] top-[1499px] w-[44.782px]" data-name="004-3d model" />;
}
...
function Group46() {
  return (
    <div className="absolute contents left-[893px] top-[619px]">
      <div className="absolute bg-[#313139] h-[6px] left-[893px] rounded-[33px] top-[619px] w-[74px]" />
      <div className="absolute bg-[#313139] h-[6px] left-[975px] rounded-[33px] top-[619px] w-[24px]" />
      <div className="absolute bg-[#313139] h-[6px] left-[939px] rounded-[33px] top-[633px] w-[24px]" />
      <div className="absolute bg-[#313139] h-[6px] left-[893px] rounded-[33px] top-[633px] w-[36px]" />
    </div>
  );
}
...
function Group47() {
  return (
    <div className="absolute contents left-[634px] top-[619px]">
      <div className="absolute bg-[#313139] h-[6px] left-[634px] rounded-[33px] top-[619px] w-[74px]" />
      <div className="absolute bg-[#313139] h-[6px] left-[716px] rounded-[33px] top-[619px] w-[24px]" />
      <div className="absolute bg-[#313139] h-[6px] left-[680px] rounded-[33px] top-[633px] w-[24px]" />
      <div className="absolute bg-[#313139] h-[6px] left-[634px] rounded-[33px] top-[633px] w-[36px]" />
    </div>
  );
}
...
function Group24() {
  return (
    <div className="absolute contents left-[634px] top-[619px]">
      <Group47 />
      <div className="absolute bg-[#313139] left-[806px] rounded-[5px] size-[20px] top-[619px]" />
    </div>
  );
}
    ...
    <div className="absolute contents left-[634px] top-[619px]">
      ...
      <div className="absolute inset-[13.42%_45.52%_84.35%_46.84%]" data-name="Vector">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 110.149 110.149">
          <path d={svgPaths.pe44c080} fill="url(#paint0_linear_1_1332)" id="Vector" />
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_1332" x1="-2.71297e-07" x2="114.203" y1="12.5169" y2="17.5157">
...
function Group48() {
  return (
    <div className="absolute contents left-[409px] top-[705px]">
      <div className="absolute bg-[#313139] h-[6px] left-[409px] rounded-[33px] top-[705px] w-[74px]" />
      <div className="absolute bg-[#313139] h-[6px] left-[491px] rounded-[33px] top-[705px] w-[24px]" />
      <div className="absolute bg-[#313139] h-[6px] left-[455px] rounded-[33px] top-[719px] w-[24px]" />
      <div className="absolute bg-[#313139] h-[6px] left-[409px] rounded-[33px] top-[719px] w-[36px]" />
    </div>
  );
}
...
function Group27() {
  return (
    <div className="absolute contents left-[369px] top-[705px]">
      <Group48 />
      <div className="absolute bg-[#313139] left-[369px] rounded-[5px] size-[20px] top-[705px]" />
    </div>
  );
}
...
function Group49() {
  return (
    <div className="absolute contents left-[409px] top-[793px]">
      <div className="absolute bg-[#313139] h-[6px] left-[409px] rounded-[33px] top-[793px] w-[74px]" />
      <div className="absolute bg-[#313139] h-[6px] left-[491px] rounded-[33px] top-[793px] w-[24px]" />
      <div className="absolute bg-[#313139] h-[6px] left-[455px] rounded-[33px] top-[807px] w-[24px]" />
      <div className="absolute bg-[#313139] h-[6px] left-[409px] rounded-[33px] top-[807px] w-[36px]" />
    </div>
  );
}
...
function Group29() {
  return (
    <div className="absolute contents left-[369px] top-[793px]">
      <Group49 />
      <div className="absolute bg-[#313139] left-[369px] rounded-[5px] size-[20px] top-[793px]" />
    </div>
  );
}
...
function Group50() {
  return (
    <div className="absolute contents left-[409px] top-[837px]">
      <div className="absolute bg-[#313139] h-[6px] left-[409px] rounded-[33px] top-[837px] w-[74px]" />
      <div className="absolute bg-[#313139] h-[6px] left-[491px] rounded-[33px] top-[837px] w-[24px]" />
      <div className="absolute bg-[#313139] h-[6px] left-[455px] rounded-[33px] top-[851px] w-[24px]" />
      <div className="absolute bg-[#313139] h-[6px] left-[409px] rounded-[33px] top-[851px] w-[36px]" />
    </div>
  );
}
...
function Group51() {
  return (
    <div className="absolute contents left-[409px] top-[881px]">
      <div className="absolute bg-[#313139] h-[6px] left-[409px] rounded-[33px] top-[881px] w-[74px]" />
      <div className="absolute bg-[#313139] h-[6px] left-[491px] rounded-[33px] top-[881px] w-[24px]" />
      <div className="absolute bg-[#313139] h-[6px] left-[455px] rounded-[33px] top-[895px] w-[24px]" />
      <div className="absolute bg-[#313139] h-[6px] left-[409px] rounded-[33px] top-[895px] w-[36px]" />
    </div>
  );
}
...
function Group31() {
  return (
    <div className="absolute contents left-[369px] top-[881px]">
      <Group51 />
      <div className="absolute bg-[#313139] left-[369px] rounded-[5px] size-[20px] top-[881px]" />
    </div>
  );
}
...
function Group52() {
  return (
    <div className="absolute contents left-[409px] top-[1006px]">
      <div className="absolute bg-[#313139] h-[6px] left-[409px] rounded-[33px] top-[1006px] w-[56px]" />
      <div className="absolute bg-[#313139] h-[6px] left-[473px] rounded-[33px] top-[1006px] w-[42px]" />
      <div className="absolute bg-[#313139] h-[6px] left-[431px] rounded-[33px] top-[1020px] w-[62px]" />
    </div>
  );
}
...
function Frame9() {
  return (
    <div className="absolute content-stretch flex items-start left-[830px] px-[28px] py-[12px] rounded-[5px] top-[2712px]" style={{ backgroundImage: "linear-gradient(97.2006deg, rgb(255, 152, 152) 0.47654%, rgb(128, 84, 255) 100%)" }}>
      <p className="font-['Poppins:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[14px] text-white whitespace-pre">Download</p>
    </div>
  );
}
...
function Group38() {
  return (
    <div className="absolute h-[33.843px] left-[165px] top-[32px] w-[131.979px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 131.979 33.8426">
        <g id="Group 127">
          <g id="Squid">
            <path d={svgPaths.p57b3400} fill="var(--fill-0, white)" />
            <path d={svgPaths.p14ec3fc0} fill="var(--fill-0, white)" />
            <path d={svgPaths.pcbcae00} fill="var(--fill-0, white)" />
            <path d={svgPaths.p20dfaa80} fill="var(--fill-0, white)" />
            <path d={svgPaths.p3438e080} fill="var(--fill-0, white)" />
          </g>
          <path d={svgPaths.p3395be00} fill="var(--fill-0, white)" id="Vector" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="absolute left-[512px] size-[32px] top-[2365px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="Group 124">
          <circle cx="16" cy="16" fill="url(#paint0_radial_1_977)" fillOpacity="0.3" id="Ellipse 15" r="16" />
          <circle cx="16" cy="16" fill="url(#paint1_radial_1_977)" id="Ellipse 14" r="9.05882" />
        </g>
        <defs>
          <radialGradient cx="0" cy="0" gradientTransform="matrix(12.3636 31.2727 -250.267 444.472 10.1818 -2.1818)" gradientUnits="userSpaceOnUse" id="paint0_radial_1_977" r="1">
            <stop stopColor="#FF9898" />
            <stop offset="1" stopColor="#8054FF" />
          </radialGradient>
          <radialGradient cx="0" cy="0" gradientTransform="matrix(7.00001 17.7059 -141.695 251.65 12.7059 5.70589)" gradientUnits="userSpaceOnUse" id="paint1_radial_1_977" r="1">
            <stop stopColor="#FF9898" />
            <stop offset="1" stopColor="#8054FF" />
          </radialGradient>
        </defs>
...
function Group39() {
  return (
    <div className="absolute inset-[15.93%_84.65%_71.54%_11.46%]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 56 45.0732">
        <g id="Group 128">
          <path d={svgPaths.p396e5f00} fill="var(--fill-0, white)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Group41() {
  return (
    <div className="absolute contents inset-[74.44%_0_0_0]">
      ...
      <p className="absolute font-['Poppins:Regular',sans-serif] inset-[83.33%_73.96%_8.89%_10.07%] leading-[28px] not-italic text-[#9e9e9e] text-[14px] whitespace-pre">All Rights Reservd Inkyy.com 2022</p>
...
function Group6() {
  return (
    <div className="absolute contents left-[925px] top-[1420px]">
      <div className="absolute bg-[#18181c] h-[371px] left-[925px] rounded-[20px] top-[1420px] w-[350px]" />
      <p className="absolute font-['Poppins:Regular',sans-serif] h-[83px] leading-[28px] left-[1100.5px] not-italic text-[#9e9e9e] text-[14px] text-center top-[1660px] translate-x-[-50%] w-[303px] whitespace-pre-wrap">{`A good design is not only aesthetically pleasing, but also functional. It should be able to solve the problem `}</p>
      <div className="absolute bg-[#222228] left-[1048px] rounded-[30px] size-[104px] top-[1470px]" />
      <p className="absolute font-['Poppins:SemiBold',sans-serif] leading-[32px] left-[1100px] not-italic text-[20px] text-center text-white top-[1613px] translate-x-[-50%] whitespace-pre">Fully Customizable</p>
    </div>
  );
}
...
function Group() {
  return (
    <div className="absolute inset-[30.33%_74.81%_68.74%_22.08%]" data-name="Group">
...
function Group1() {
  return (
    <div className="absolute inset-[30.35%_48.4%_68.74%_48.54%]" data-name="Group">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 43.9999 44.6574">
        <g id="Group">
          <path d={svgPaths.p3026c800} fill="var(--fill-0, white)" id="Vector" />
        </g>
      </svg>
    </div>
  );
    ...
    <div className="absolute contents left-[1048px] top-[1470px]">
      <div className="absolute left-[1048px] size-[104px] top-[1470px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 104 104">
          <path d={svgPaths.p411600} fill="url(#paint0_linear_1_987)" id="Rectangle 28" />
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_987" x1="31" x2="104.587" y1="-9.39648e-06" y2="75.3118">
              <stop stopColor="#FF9898" />
              <stop offset="1" stopColor="#8054FF" />
            </linearGradient>
          </defs>
...
function Group56() {
  return (
    <div className="absolute contents left-[165px] top-[1420px]">
      <Group6 />
      <div className="absolute bg-[#18181c] h-[371px] left-[925px] rounded-[20px] top-[1821px] w-[350px]" />
      <div className="absolute bg-[#222228] left-[1048px] rounded-[30px] size-[104px] top-[1871px]" />
      <p className="absolute font-['Poppins:SemiBold',sans-serif] leading-[32px] left-[1100px] not-italic text-[20px] text-center text-white top-[2014px] translate-x-[-50%] whitespace-pre">Fully Customizable</p>
      <div className="absolute bg-[#18181c] h-[371px] left-[165px] rounded-[20px] top-[1420px] w-[350px]" />
      <p className="absolute font-['Poppins:Regular',sans-serif] h-[83px] leading-[28px] left-[340.5px] not-italic text-[#9e9e9e] text-[14px] text-center top-[1660px] translate-x-[-50%] w-[303px] whitespace-pre-wrap">{`A good design is not only aesthetically pleasing, but also functional. It should be able to solve the problem `}</p>
      <div className="absolute bg-[#222228] left-[288px] rounded-[30px] size-[104px] top-[1470px]" />
      <p className="absolute font-['Poppins:SemiBold',sans-serif] leading-[32px] left-[340px] not-italic text-[20px] text-center text-white top-[1613px] translate-x-[-50%] whitespace-pre">Fully Customizable</p>
      <div className="absolute bg-[#18181c] h-[371px] left-[545px] rounded-[20px] top-[1420px] w-[350px]" />
      <p className="absolute font-['Poppins:Regular',sans-serif] h-[83px] leading-[28px] left-[720.5px] not-italic text-[#9e9e9e] text-[14px] text-center top-[1660px] translate-x-[-50%] w-[303px] whitespace-pre-wrap">{`A good design is not only aesthetically pleasing, but also functional. It should be able to solve the problem `}</p>
      <div className="absolute bg-[#222228] left-[668px] rounded-[30px] size-[104px] top-[1470px]" />
      <p className="absolute font-['Poppins:SemiBold',sans-serif] leading-[32px] left-[720px] not-italic text-[20px] text-center text-white top-[1613px] translate-x-[-50%] whitespace-pre">Fully Customizable</p>
      <div className="absolute bg-[#18181c] h-[371px] left-[165px] rounded-[20px] top-[1821px] w-[350px]" />
      <div className="absolute bg-[#222228] left-[288px] rounded-[30px] size-[104px] top-[1871px]" />
      <p className="absolute font-['Poppins:SemiBold',sans-serif] leading-[32px] left-[340px] not-italic text-[20px] text-center text-white top-[2014px] translate-x-[-50%] whitespace-pre">Fully Customizable</p>
      <div className="absolute bg-[#18181c] h-[371px] left-[545px] rounded-[20px] top-[1821px] w-[350px]" />
      <div className="absolute bg-[#222228] left-[668px] rounded-[30px] size-[104px] top-[1871px]" />
      <p className="absolute font-['Poppins:SemiBold',sans-serif] leading-[32px] left-[720px] not-italic text-[20px] text-center text-white top-[2014px] translate-x-[-50%] whitespace-pre">Fully Customizable</p>
      <Group />
      <Group1 />
      <Group14 />
      <Group16 />
    ...
    <div className="absolute inset-[18.82%_43.35%_79.29%_44.72%]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 171.75 93.34">
        <g id="Group 132">
          ...
          <path d={svgPaths.p3a69ebf0} fill="url(#paint0_linear_1_958)" id="Vector_8" />
          <path d={svgPaths.pb0cae72} fill="url(#paint1_linear_1_958)" id="Vector_9" />
          <path d={svgPaths.p2b7d6800} fill="url(#paint2_linear_1_958)" id="Vector_10" />
          <path d={svgPaths.p32916d00} fill="url(#paint3_linear_1_958)" id="Vector_11" />
          <path d={svgPaths.p305f7600} fill="url(#paint4_linear_1_958)" id="Vector_12" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_958" x1="163.5" x2="193.116" y1="2.99997" y2="19.2608">
            <stop stopColor="#FF9898" />
            <stop offset="1" stopColor="#8054FF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_1_958" x1="132.887" x2="160.117" y1="15.0978" y2="32.1472">
            <stop stopColor="#FF9898" />
            <stop offset="1" stopColor="#8054FF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_1_958" x1="101.887" x2="124.225" y1="34.5734" y2="53.2213">
            <stop stopColor="#FF9898" />
            <stop offset="1" stopColor="#8054FF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint3_linear_1_958" x1="71.8867" x2="88.8168" y1="49.18" y2="68.0245">
            <stop stopColor="#FF9898" />
            <stop offset="1" stopColor="#8054FF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint4_linear_1_958" x1="41.8867" x2="48.2512" y1="71.09" y2="85.2583">
            <stop stopColor="#FF9898" />
            <stop offset="1" stopColor="#8054FF" />
          </linearGradient>
        </defs>
...
export default function Homepage() {
  return (
    <div className="bg-black relative size-full" data-name="Homepage">
      <Group7 />
      <div className="absolute h-[474.398px] left-[-3px] top-[777px] w-[1446px]" data-name="Subtract">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1446 474.398">
          <path d={svgPaths.p34fd8780} fill="url(#paint0_linear_1_1063)" id="Subtract" />
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_1063" x1="-3.5615e-06" x2="1475.83" y1="53.9089" y2="250.81">
              <stop stopColor="#FF9898" />
              <stop offset="1" stopColor="#8054FF" />
            </linearGradient>
          </defs>
      ...
      <div className="absolute left-[611px] size-[66px] top-[2456px]">
        <img alt="" className="block max-w-none size-full" height="66" src={imgEllipse9} width="66" />
      </div>
      <div className="absolute left-[371px] size-[66px] top-[2709px]">
        <img alt="" className="block max-w-none size-full" height="66" src={imgEllipse10} width="66" />
      </div>
      <div className="absolute left-[279px] size-[66px] top-[2431px]">
        <img alt="" className="block max-w-none size-full" height="66" src={imgEllipse11} width="66" />
      </div>
      <div className="absolute left-[451px] size-[538px] top-[-30px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 538 538">
          <circle cx="269" cy="269" fill="url(#paint0_radial_1_1023)" id="Ellipse 5" r="269" />
          <defs>
            <radialGradient cx="0" cy="0" gradientTransform="translate(269 269) rotate(90) scale(269)" gradientUnits="userSpaceOnUse" id="paint0_radial_1_1023" r="1">
      ...
      <div className="absolute bg-[#18181c] h-[725px] left-0 top-[2945px] w-[1440px]" />
      <p className="absolute font-['Poppins:Regular',sans-serif] h-[83px] leading-[28px] left-[1100.5px] not-italic text-[#9e9e9e] text-[14px] text-center top-[2061px] translate-x-[-50%] w-[303px] whitespace-pre-wrap">{`A good design is not only aesthetically pleasing, but also functional. It should be able to solve the problem `}</p>
      <p className="absolute font-['Poppins:SemiBold',sans-serif] leading-[80px] left-[720.5px] not-italic text-[64px] text-center text-white top-[169px] translate-x-[-50%] whitespace-pre">
        Beautiful Landing Page
        <br aria-hidden="true" />
        Design for You
      </p>
      <p className="absolute font-['Poppins:SemiBold',sans-serif] leading-[80px] left-[336px] not-italic text-[48px] text-center text-white top-[1236px] translate-x-[-50%] whitespace-pre">Feature Boxes</p>
      <p className="absolute font-['Poppins:SemiBold',sans-serif] leading-[64px] left-[720.5px] not-italic text-[48px] text-center text-white top-[3057px] translate-x-[-50%] whitespace-pre">
        Companies we Worked
        <br aria-hidden="true" />
        With in SInce 2015
      </p>
      ...
      <p className="absolute font-['Poppins:Regular',sans-serif] h-[66px] leading-[28px] left-[720.5px] not-italic text-[#9e9e9e] text-[18px] text-center top-[347px] translate-x-[-50%] w-[577px] whitespace-pre-wrap">{`A good design is not only aesthetically pleasing, but also functional. It should be able to solve the problem `}</p>
      <Frame2 />
      <Frame8 />
      <div className="absolute bg-[#131415] h-[553px] left-[287px] rounded-[28px] top-[551px] w-[866px]" />
      <p className="absolute font-['Poppins:Regular',sans-serif] h-[83px] leading-[28px] left-[340.5px] not-italic text-[#9e9e9e] text-[14px] text-center top-[2061px] translate-x-[-50%] w-[303px] whitespace-pre-wrap">{`A good design is not only aesthetically pleasing, but also functional. It should be able to solve the problem `}</p>
      <p className="absolute font-['Poppins:Regular',sans-serif] h-[83px] leading-[28px] left-[720.5px] not-italic text-[#9e9e9e] text-[14px] text-center top-[2061px] translate-x-[-50%] w-[303px] whitespace-pre-wrap">{`A good design is not only aesthetically pleasing, but also functional. It should be able to solve the problem `}</p>
      <div className="absolute bg-black h-[92px] left-[165px] rounded-[10px] top-[3255px] w-[160px]" />
      <div className="absolute bg-black h-[92px] left-[355px] rounded-[10px] top-[3255px] w-[160px]" />
      <div className="absolute bg-black h-[92px] left-[545px] rounded-[10px] top-[3255px] w-[160px]" />
      <div className="absolute bg-black h-[92px] left-[735px] rounded-[10px] top-[3255px] w-[160px]" />
      <div className="absolute bg-black h-[92px] left-[925px] rounded-[10px] top-[3255px] w-[160px]" />
      <div className="absolute bg-black h-[92px] left-[1115px] rounded-[10px] top-[3255px] w-[160px]" />
      ...
      <p className="absolute font-['Poppins:SemiBold',sans-serif] leading-[65px] left-[262px] not-italic text-[48px] text-white top-[3584px] w-[499px] whitespace-pre-wrap">Fell Free to Join our 15 Days Free Trial</p>
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[32px] left-[354px] not-italic text-[20px] text-center text-white top-[3540px] translate-x-[-50%] whitespace-pre">Love our Our Tool?</p>
      <Frame3 />
      <Frame4 />
      <Frame5 />
      <Frame6 />
      <p className="absolute font-['Poppins:SemiBold',sans-serif] leading-[80px] left-[887px] not-italic text-[48px] text-center text-white top-[3961px] translate-x-[-50%] whitespace-pre">Get In Touch</p>
      ...
      <Group11 />
      <Group12 />
      <div className="absolute bg-[#222228] h-[460px] left-[340px] rounded-[20px] top-[594px] w-[246px]" />
      <div className="absolute bg-[#222228] h-[217px] left-[614px] rounded-[20px] top-[594px] w-[231px]" />
      <div className="absolute bg-[#222228] h-[217px] left-[614px] rounded-[20px] top-[837px] w-[231px]" />
      <div className="absolute bg-[#222228] h-[328px] left-[873px] rounded-[20px] top-[594px] w-[230px]" />
      <div className="absolute bg-[#222228] h-[103px] left-[873px] rounded-[20px] top-[948px] w-[230px]" />
      <div className="absolute left-[1223px] size-[96px] top-[303px]">
        <div className="absolute inset-[-20.83%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 136 136">
            <g filter="url(#filter0_f_1_1328)" id="Ellipse 3">
              <circle cx="68" cy="68" fill="url(#paint0_radial_1_1328)" r="48" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="136" id="filter0_f_1_1328" width="136" x="0" y="0">
                <feFlood floodOpacity="0" result="BackgroundImageFix" />
                <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                <feGaussianBlur result="effect1_foregroundBlur_1_1328" stdDeviation="10" />
              </filter>
              <radialGradient cx="0" cy="0" gradientTransform="matrix(3.99998 101.2 -1153.96 1014.13 61.2 13.1999)" gradientUnits="userSpaceOnUse" id="paint0_radial_1_1328" r="1">
      ...
      <div className="absolute left-[656px] size-[64px] top-[70px]">
        <div className="absolute inset-[-31.25%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 104 104">
            <g filter="url(#filter0_f_1_1051)" id="Ellipse 13">
              <circle cx="52" cy="52" fill="url(#paint0_radial_1_1051)" r="32" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="104" id="filter0_f_1_1051" width="104" x="0" y="0">
                <feFlood floodOpacity="0" result="BackgroundImageFix" />
                <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                <feGaussianBlur result="effect1_foregroundBlur_1_1051" stdDeviation="10" />
              </filter>
              <radialGradient cx="0" cy="0" gradientTransform="matrix(2.66666 67.4667 -769.307 676.085 47.4667 15.4666)" gradientUnits="userSpaceOnUse" id="paint0_radial_1_1051" r="1">
                <stop stopColor="#494955" />
                <stop offset="1" stopColor="#141414" />
              </radialGradient>
            </defs>
      ...
      <div className="absolute left-[122px] size-[130px] top-[400px]">
        <div className="absolute inset-[-23.08%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 190 190">
            <g filter="url(#filter0_f_1_1029)" id="Ellipse 14">
              <circle cx="95" cy="95" fill="url(#paint0_radial_1_1029)" r="65" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="190" id="filter0_f_1_1029" width="190" x="0" y="0">
                <feFlood floodOpacity="0" result="BackgroundImageFix" />
                <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                <feGaussianBlur result="effect1_foregroundBlur_1_1029" stdDeviation="15" />
              </filter>
              <radialGradient cx="0" cy="0" gradientTransform="matrix(5.41665 137.042 -1562.65 1373.3 85.7917 20.7916)" gradientUnits="userSpaceOnUse" id="paint0_radial_1_1029" r="1">
                <stop stopColor="#494955" />
                <stop offset="1" stopColor="#141414" />
              </radialGradient>
            </defs>
      ...
      <Group23 />
      <Group26 />
      <div className="absolute flex h-[184px] items-center justify-center left-[879px] top-[722px] w-[214px]">
        <div className="flex-none rotate-[180deg]">
          <div className="bg-gradient-to-b from-[#222228] h-[184px] to-[rgba(34,34,40,0)] w-[214px]" />
        </div>
      </div>
      <Frame1 />
      <Group27 />
      ...
      <Frame9 />
      <Group38 />
      <div className="absolute inset-[51.17%_65.21%_47.75%_30.28%]" data-name="Vector">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 65 53">
          <path d={svgPaths.p970a480} fill="var(--fill-0, white)" id="Vector" />
        </svg>
      </div>
      <Group35 />
      <Group36 />
      <Group37 />
      <div className="absolute inset-[12.53%_66.46%_86.81%_30.69%]" data-name="Vector">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 41 33">
          <path d={svgPaths.p3395be00} fill="var(--fill-0, #313139)" id="Vector" />
        </svg>
      </div>
      <div className="absolute h-0 left-[369px] top-[672px] w-[184px]">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 184 1">
            <line id="Line 15" stroke="var(--stroke-0, #313139)" x2="184" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
      <Group28 />
      <div className="absolute h-[360px] left-0 top-[4582px] w-[1440px]">
      ...
      <Group43 />
      <Group55 />
      <div className="absolute h-0 left-[638px] top-[900px] w-[192px]">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 192 1">
            <line id="Line 16" stroke="var(--stroke-0, #313139)" x2="192" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[28px] left-[1022px] not-italic text-[#9e9e9e] text-[14px] text-center top-[35px] translate-x-[-50%] whitespace-pre">Home</p>
      <Group44 />
